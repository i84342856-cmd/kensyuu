...
// ここを SpareMarketDataServiceImpl から MarketDataService に変更
import com.example.cryptotool.service.MarketDataService;

@RestController
public class TradeRestController {

    // ここも MarketDataService に変更
    private final MarketDataService marketDataService;

    // コンストラクタも MarketDataService に変更
    public TradeRestController(MarketDataService marketDataService) {
