...
public class ReservationController {
                        ...
                        Model model) 
    {
     ...
     // 定員チェック
        if (numberOfPeople != null) {
            if (!reservationService.isWithinCapacity(capacity,numberOfPeople)) {
                          ...
                          Model model) 
    {
        ...
        Integer amount = reservationService.calculateAmount(price,checkinDate, checkoutDate);
    ...
    // 決済処理を実行せずに予約データを保存する場合
    @PostMapping("/houses/{id}/reservations/create")
    public String create(ReservationRegisterForm reservationRegisterForm) {
